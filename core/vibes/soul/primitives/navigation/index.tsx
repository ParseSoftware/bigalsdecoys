...
export const Navigation = forwardRef(function Navigation<S extends SearchResult>(
  ...
  return (
    <NavigationMenu.Root
      className={clsx('__max-w-screen-2xl relative mx-auto w-full @container', className)}
      delayDuration={0}
    ...
    >
      <div
        className={clsx(
          '@4xl:__rounded-2xl flex items-center justify-between gap-1 bg-[var(--nav-background,hsl(var(--background)))] py-2 pl-3 pr-2 transition-shadow @4xl:px-2 @4xl:pl-6 @4xl:pr-2.5',
          isFloating
      ...
      >
        ...
        <Popover.Root onOpenChange={setIsMobileMenuOpen} open={isMobileMenuOpen}>
          ...
          <Popover.Portal>
            <Popover.Content className="z-10 max-h-[calc(var(--radix-popover-content-available-height)-8px)] w-[var(--radix-popper-anchor-width)] @container data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95">
        ...
        <ul
          className={clsx(
            'hidden gap-1 uppercase @4xl:flex @4xl:flex-1',
            {
